                ...
                <center>
                    <table border="1" >
						...
						<?php
							...
							$bloodgroup = $_GET['groupid'];
							if($bloodgroup == 1)
							{
								$s = "select fname,sname,bgroup,email,phone,lastdate from signinaccount where bgroup='A+'";
							}
							...
							{
								$s = "select fname,sname,bgroup,email,phone,lastdate from signinaccount where bgroup='B+'";
							}
							...
							{
								$s = "select fname,sname,bgroup,email,phone,lastdate from signinaccount where bgroup='AB+'";
							}
							...
							{
								$s = "select fname,sname,bgroup,email,phone,lastdate from signinaccount where bgroup='O+'";
							}
							...
							{
								$s = "select fname,sname,bgroup,email,phone,lastdate from signinaccount";
							}
