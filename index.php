...
style="weight:100%; height:500px; overflow-y:auto;"
--%> -->
...
<html lang="en-US">
    ...
    <body>
        ...
        <div class="imgeber">
            <figure>
                <div class="slide"><img src="Image/image1.jpg" alt="" /></div>

                <div class="slide"><img src="Image/image2.jpg" alt="" /></div>

                <div class="slide"><img src="Image/image3.jpg" alt="" /></div>

                <div class="slide"><img src="Image/image4.jpg" alt="" /></div>
            </figure>
        </div>
	...
	<br><br><br><br>
                ...
                <center>
                    <table border="3">
						...
						<?php
							...
							$s = "select fname,sname,bgroup,email,phone,bdate,address from signinaccount where id<=10";
        ...
        <div class="button1">
            <div class="container">
                <a href="donor_list.php?groupid=9"><input type="button" value="See More" /> </a>
            </div>
        </div>
